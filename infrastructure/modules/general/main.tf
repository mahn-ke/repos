...
resource "github_repository_file" "workflow_restore" {
  repository          = github_repository.repos.name
  file                = ".github/workflows/autogenerated-restore.yml"
  content             = "${var.auto_generated_header}\n${file("${path.module}/src/.github/workflows/restore.yml")}"
  commit_message      = "Managed by Terraform${strcontains(github_repository.repos.name, "repos") ? " [no ci]" : ""}"
  overwrite_on_create = true
}
...
# resource "github_repository_file" "infrastructure-envrc" {
#   repository          = github_repository.repos.name
#   file                = "infrastructure/.envrc"
#   content             = "${var.auto_generated_header}\n${replace(replace(file("${path.module}/infrastructure/.envrc"), "$REPOSITORY", github_repository.repos.name), "-by-vincent", "")}"
#   commit_message      = "Managed by Terraform${strcontains(github_repository.repos.name, "repos") ? " [no ci]" : ""}"
#   overwrite_on_create = true
# }
...
# resource "github_repository_file" "service-envrc" {
#   repository          = github_repository.repos.name
#   file                = "service/.envrc"
#   content             = "${var.auto_generated_header}\n${replace(replace(file("${path.module}/service/.envrc"), "$REPOSITORY", github_repository.repos.name), "-by-vincent", "")}"
#   commit_message      = "Managed by Terraform${strcontains(github_repository.repos.name, "repos") ? " [no ci]" : ""}"
#   overwrite_on_create = true
# }
